...
const MAIN_PROCESS_REQUEST = require('./main-request');
...
function createSplash() {
  ...
  splashScreen.loadURL(isDev ? `file://${path.join(__dirname, './static/splash-screen.html')}` : `file://${path.join(__dirname, './static/splash-screen.html')}`);
};
